...
function DisplayList (items, wrapper, rows_per_page, page) {
	...
	for (let i = 0; i < paginatedItems.length; i++) {
		...
		let item1 = paginatedItems[i].name;
        let item2 = paginatedItems[i].email;
		...
		item_element1.classList.add('item1');
		item_element1.innerText = item1;
		
		let item_element2 = document.createElement('div');
		item_element2.classList.add('item2');
		item_element2.innerText = item2;
		
		wrapper.append(item_element,item_element1,item_element2);
